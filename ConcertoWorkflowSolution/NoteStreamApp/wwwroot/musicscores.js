...
function getHappyMusicScore() {
  return {
    ...
    Notes: [
      ...
      { Id: "3",  NoteName: "A3", Type: playbackType, NoteLength: "1/4",  Interval: "3/32"  },
      ...
      { Id: "8",  NoteName: "G3", Type: playbackType, NoteLength: "1/8",  Interval: "3/16"  },
      { Id: "9",  NoteName: "A3", Type: playbackType, NoteLength: "1/4",  Interval: "3/32"  },
      ...
      { Id: "14", NoteName: "G3", Type: playbackType, NoteLength: "1/8",  Interval: "3/16"  },
      { Id: "15", NoteName: "G4", Type: playbackType, NoteLength: "1/4",  Interval: "3/32"  },
      ...
      { Id: "21", NoteName: "F4", Type: playbackType, NoteLength: "1/8",  Interval: "3/16"  },
      { Id: "22", NoteName: "E4", Type: playbackType, NoteLength: "1/4",  Interval: "3/32"  },
...
function getXFilesMusicScore() {
  return {
    ...
    Notes: [
      ...
      { Id: "3",  NoteName: "A#4", Type: playbackType, NoteLength: "1/4",  Interval: "1/4"  },
      { Id: "4",  NoteName: "C5",  Type: playbackType, NoteLength: "1/4",  Interval: "1/4"  },
      { Id: "5",  NoteName: "D#5", Type: playbackType, NoteLength: "1/4",  Interval: "1/4"  },
      { Id: "6",  NoteName: "C5",  Type: playbackType, NoteLength: "1/8", Interval: "1/4"  },
      { Id: "7",  NoteName: "C5",  Type: playbackType, NoteLength: "1/2",  Interval: "1/4"  },

      { Id: "8",  NoteName: "F4",  Type: playbackType, NoteLength: "1/4",  Interval: "1/2" },
      { Id: "9",  NoteName: "C5",  Type: playbackType, NoteLength: "1/4",  Interval: "1/4"  },
      { Id: "10", NoteName: "A#4", Type: playbackType, NoteLength: "1/4",  Interval: "1/4"  },
      { Id: "11", NoteName: "C5",  Type: playbackType, NoteLength: "1/4",  Interval: "1/4"  },
      { Id: "12", NoteName: "F5",  Type: playbackType, NoteLength: "1/4",  Interval: "1/4"  },
      { Id: "13", NoteName: "C5",  Type: playbackType, NoteLength: "1/8", Interval: "1/4"  },
      { Id: "14", NoteName: "C5",  Type: playbackType, NoteLength: "1/2",  Interval: "1/4"  },

      { Id: "15", NoteName: "G#5", Type: playbackType, NoteLength: "1/4",  Interval: "1/2" },
      { Id: "16", NoteName: "G5",  Type: playbackType, NoteLength: "1/4",  Interval: "1/4"  },
      { Id: "17", NoteName: "F5",  Type: playbackType, NoteLength: "1/4",  Interval: "1/4"  },
      { Id: "18", NoteName: "D#5", Type: playbackType, NoteLength: "1/4",  Interval: "1/4"  },
      { Id: "19", NoteName: "F5",  Type: playbackType, NoteLength: "1/4",  Interval: "1/4"  },
      { Id: "20", NoteName: "C5",  Type: playbackType, NoteLength: "1/8", Interval: "1/4"  },
      { Id: "21", NoteName: "C5",  Type: playbackType, NoteLength: "1/2",  Interval: "1/4"  }
    ]
  };
}
...
function getRickMusicScore() {
  return {
    ...
    Repeats: 2,
    Notes: [
      { Id: "1",  NoteName: "G3", Type: playbackType, NoteLength: "1/8",   Interval: "3/16"  },
      { Id: "2",  NoteName: "A3", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "3",  NoteName: "C4", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "4",  NoteName: "A3", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "5",  NoteName: "E4", Type: playbackType, NoteLength: "3/16",  Interval: "3/32"  },
      { Id: "6",  NoteName: "E4", Type: playbackType, NoteLength: "1/8",   Interval: "1/4"   },
      { Id: "7",  NoteName: "D4", Type: playbackType, NoteLength: "3/8",   Interval: "3/16"  },

      { Id: "8",  NoteName: "G3", Type: playbackType, NoteLength: "1/8",   Interval: "3/8"   },
      { Id: "9",  NoteName: "A3", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "10", NoteName: "C4", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "11", NoteName: "A3", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "12", NoteName: "D4", Type: playbackType, NoteLength: "3/16",  Interval: "3/32"  },
      { Id: "13", NoteName: "D4", Type: playbackType, NoteLength: "1/8",   Interval: "4/16"  },
      { Id: "14", NoteName: "C4", Type: playbackType, NoteLength: "1/8",   Interval: "3/16"  },
      { Id: "15", NoteName: "B3", Type: playbackType, NoteLength: "1/8",   Interval: "3/16"  },
      { Id: "16", NoteName: "A3", Type: playbackType, NoteLength: "1/4",   Interval: "3/32"  },

      { Id: "17", NoteName: "G3", Type: playbackType, NoteLength: "1/8",   Interval: "3/16"  },
      { Id: "18", NoteName: "A3", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "19", NoteName: "C4", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "20", NoteName: "A3", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "21", NoteName: "C4", Type: playbackType, NoteLength: "3/16",  Interval: "3/32"  },
      { Id: "22", NoteName: "D4", Type: playbackType, NoteLength: "1/8",   Interval: "3/16"  },
      { Id: "23", NoteName: "B3", Type: playbackType, NoteLength: "1/8",   Interval: "3/16"  },
      { Id: "24", NoteName: "A3", Type: playbackType, NoteLength: "1/8",   Interval: "3/16"  },
      { Id: "25", NoteName: "G3", Type: playbackType, NoteLength: "1/4.",  Interval: "3/32"  },
      { Id: "26", NoteName: "G3", Type: playbackType, NoteLength: "1/8",   Interval: "1/4"   },
      { Id: "27", NoteName: "D4", Type: playbackType, NoteLength: "3/16",  Interval: "1/4"   },
      { Id: "28", NoteName: "C4", Type: playbackType, NoteLength: "3/8",   Interval: "1/4"   },

      { Id: "29", NoteName: "G3", Type: playbackType, NoteLength: "1/8",   Interval: "3/8"   },
      { Id: "30", NoteName: "A3", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "31", NoteName: "C4", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "32", NoteName: "A3", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "33", NoteName: "E4", Type: playbackType, NoteLength: "3/16",  Interval: "3/32"  },
      { Id: "34", NoteName: "E4", Type: playbackType, NoteLength: "1/8",   Interval: "1/4"   },
      { Id: "35", NoteName: "D4", Type: playbackType, NoteLength: "3/8",   Interval: "3/16"  },

      { Id: "36", NoteName: "G3", Type: playbackType, NoteLength: "1/8",   Interval: "3/8"   },
      { Id: "37", NoteName: "A3", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "38", NoteName: "C4", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "39", NoteName: "A3", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "40", NoteName: "G4", Type: playbackType, NoteLength: "1/4",   Interval: "3/32"  },
      { Id: "41", NoteName: "B3", Type: playbackType, NoteLength: "1/8",   Interval: "3/16"  },
      { Id: "42", NoteName: "C4", Type: playbackType, NoteLength: "1/8",   Interval: "3/16"  },
      { Id: "43", NoteName: "B3", Type: playbackType, NoteLength: "1/8",   Interval: "3/16"  },
      { Id: "44", NoteName: "A3", Type: playbackType, NoteLength: "1/4",   Interval: "3/32"  },

      { Id: "45", NoteName: "G3", Type: playbackType, NoteLength: "1/8",   Interval: "1/4"   },
      { Id: "46", NoteName: "A3", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "47", NoteName: "C4", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "48", NoteName: "A3", Type: playbackType, NoteLength: "1/16",  Interval: "3/32"  },
      { Id: "49", NoteName: "C4", Type: playbackType, NoteLength: "1/4",   Interval: "3/32"  },
      { Id: "50", NoteName: "D4", Type: playbackType, NoteLength: "1/8",   Interval: "3/16"  },
      { Id: "51", NoteName: "B3", Type: playbackType, NoteLength: "1/8",   Interval: "3/16"  },
      { Id: "52", NoteName: "A3", Type: playbackType, NoteLength: "1/8",   Interval: "3/16"  },
      { Id: "53", NoteName: "G3", Type: playbackType, NoteLength: "1/4.",  Interval: "3/32"  },
      { Id: "54", NoteName: "G3", Type: playbackType, NoteLength: "1/8",   Interval: "1/4"   },
      { Id: "55", NoteName: "D4", Type: playbackType, NoteLength: "3/16",  Interval: "1/8"   },
      { Id: "56", NoteName: "C4", Type: playbackType, NoteLength: "3/8",   Interval: "1/4"   }
    ]
  };
}
...
function getFinalScore() {
  return {
    ...
    Notes: [
      ...
      { Id: "5",  NoteName: "D5",  Type: playbackType, NoteLength: "1/16", Interval: "1/2." },
      ...
      { Id: "9",  NoteName: "B4",  Type: playbackType, NoteLength: "1/3",  Interval: "1/8"  },

      { Id: "10", NoteName: "D5",  Type: playbackType, NoteLength: "1/16", Interval: "1/2." },
      { Id: "11", NoteName: "C#5", Type: playbackType, NoteLength: "1/16", Interval: "1/16" },
      { Id: "12", NoteName: "D5",  Type: playbackType, NoteLength: "1/8.",  Interval: "1/16" },
      { Id: "13", NoteName: "F#4", Type: playbackType, NoteLength: "1/8.",  Interval: "1/4"  },
      { Id: "14", NoteName: "G#4", Type: playbackType, NoteLength: "1/4.",  Interval: "1/4" },

      { Id: "15", NoteName: "B4",  Type: playbackType, NoteLength: "1/16", Interval: "1/4."  },
      ...
      { Id: "21", NoteName: "A4",  Type: playbackType, NoteLength: "1/3",  Interval: "1/8"  }
    ]
  };
}
