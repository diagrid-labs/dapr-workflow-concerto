...
function getXFilesMusicScore() {
  return {
    ...
    Notes: [
      ...
      { Id: "6",  NoteName: "C5",  Type: playbackType, NoteLength: "3/8", Interval: "1/2"  },
      ...
      { Id: "13", NoteName: "C5",  Type: playbackType, NoteLength: "3/8", Interval: "1/2"  },
      ...
      { Id: "20", NoteName: "C5",  Type: playbackType, NoteLength: "3/8", Interval: "1/2"  },
